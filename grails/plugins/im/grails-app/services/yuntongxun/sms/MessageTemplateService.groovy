...
class MessageTemplateService {
    ...
    protected Class<MessageTemplate> persistentClass = null//(Class<MessageTemplate>) ((ParameterizedType)(this.getClass().getGenericSuperclass())).getActualTypeArguments()[0]
     ...
     */
    @Transactional
    def save(MessageTemplate instance) throws Exception {
        instance.save()
    }
     ...
     */
    @Transactional
    def saveBatch(List<MessageTemplate> instances) throws Exception {
     ...
     */
    @Transactional
    def updateBath(List<MessageTemplate> instances)  throws Exception {
        if(instances && !instances.isEmpty()){
            instances.each {
                save(it)
            }
     ...
     */
    @Transactional
    def update(MessageTemplate instance) throws Exception {
        instance.save()
    }
     ...
     */
    @Transactional
    def update(MessageTemplate instance,boolean included,Collection<String> fields) throws Exception {
        //TODO
     ...
     */
    @Transactional
    def delete(MessageTemplate instance) throws Exception {
        instance.delete()
    }
    ...
    void deleteById(Serializable id) {
        MessageTemplate instance = persistentClass.get(id)
        instance?.delete()
    }
    ...
    void deleteByIds(List<Long> ids) {
        if(ids != null && !ids.isEmpty()){
            ids.each {
                MessageTemplate instance = persistentClass.get(it)
                instance?.delete()
            }
        }
    }
     ...
     * @return
     */
    MessageTemplate findById(Serializable id) {
     ...
     * @return
     */
    List<MessageTemplate> findByIds(List<Serializable> ids){
        if(ids != null && !ids.isEmpty()){
     ...
     * @return
     */
    List<MessageTemplate> findByIds(List<Serializable> ids,boolean ignoreNull){
        //TODO
     ...
     * @return
     */
    List<MessageTemplate> findAll(Closure closure,def page = null){
        if(closure == null){
            closure = {}
        }
     ...
     * @return
     */
    List<MessageTemplate> findAll(List<Closure> closures,def page = null){
     ...
     * @return
     */
    List<MessageTemplate> findAll(Closure closure,def page,List<String> orderBys){
        //合并条件查询和排序查询的闭包
     ...
     * @return
     */
    List<MessageTemplate> findByProperties(Map<String, Object> properties, def page = null){
     ...
     * @return
     */
    List<MessageTemplate> findByProperties(Map<String, Object> properties, def page,
                             List<String> orderBys) {
        List<MessageTemplate> l = null
     ...
     * @return
     */
    def findByHql(String hql,Map<String,Object> args,def page,Map<String,Object> properties = null){
     ...
     * @return
     */
    def findByHql(String hql,Map<String,Object> args,def page,List<String> orders, Map<String,Object> properties = null){
        if(args == null){
            args = [:]
        }
     ...
     * @return
     */
    def findBySQL(String sql,Map<String,Object> args,def page,Map<String,Object> properties = null){
     ...
     * @return
     */
    def findBySQL(String sql,Map<String,Object> args,def page,List<String> orders, Map<String,Object> properties = null){
     ...
     * @return
     */
    List<MessageTemplate> list(Map params)
    {
