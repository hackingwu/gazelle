...
public interface GrailsTemplateGenerator {
     ...
     * @throws IOException
     */
    void generateService(GrailsDomainClass domainClass,Writer out) throws IOException ;
     ...
     * @throws IOException
     */
    void generateService(GrailsDomainClass domainClass,String destDir) throws IOException;
     ...
     * @throws IOException
     */
    void generateServiceTest(GrailsDomainClass domainClass,Writer out) throws IOException;
     ...
     * @throws IOException
     */
    void generateServiceTest(GrailsDomainClass domainClass, String destDir)throws IOException;
