...
class ${className}Service {
    ...
    protected Class<${className}> persistentClass = null//(Class<${className}>) ((ParameterizedType)(this.getClass().getGenericSuperclass())).getActualTypeArguments()[0]
     ...
     */
    @Transactional
    def save(${className} instance) throws Exception {
        instance.save()
    }
     ...
     */
    @Transactional
    def saveBatch(List<${className}> instances) throws Exception {
     ...
     */
    @Transactional
    def updateBath(List<${className}> instances)  throws Exception {
        if(instances && !instances.isEmpty()){
            instances.each {
                save(it)
            }
     ...
     */
    @Transactional
    def update(${className} instance) throws Exception {
        instance.save()
    }
     ...
     */
    @Transactional
    def update(${className} instance,boolean included,Collection<String> fields) throws Exception {
        //TODO
     ...
     */
    @Transactional
    def delete(${className} instance) throws Exception {
        instance.delete()
    }
    ...
    void deleteById(Serializable id) {
        ${className} instance = persistentClass.get(id)
        instance?.delete()
    }
    ...
    void deleteByIds(List<Long> ids) {
        if(ids != null && !ids.isEmpty()){
            ids.each {
                ${className} instance = persistentClass.get(it)
                instance?.delete()
            }
        }
    }
     ...
     * @return
     */
    List<${className}> findByIds(List<Serializable> ids){
        if(ids != null && !ids.isEmpty()){
     ...
     * @return
     */
    List<${className}> findByIds(List<Serializable> ids,boolean ignoreNull){
        //TODO
     ...
     * @return
     */
    List<${className}> findAll(Closure closure,Page page = null){
        if(closure == null){
            closure = {}
        }
     ...
     * @return
     */
    List<${className}> findAll(List<Closure> closures,Page page = null){
     ...
     * @return
     */
    List<${className}> findAll(Closure closure,Page page,List<String> orderBys){
        //合并条件查询和排序查询的闭包
     ...
     * @return
     */
    List<${className}> findByProperties(Map<String, Object> properties, Page page = null){
     ...
     * @return
     */
    List<${className}> findByProperties(Map<String, Object> properties, Page page,
     ...
     * @return
     */
    List<${className}> list(Map params)
    {
