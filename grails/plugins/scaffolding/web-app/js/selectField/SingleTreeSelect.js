 ...
 */
    ...
    Ext.define('Ext.selectField.SingleTreeSelect', {
    extend: 'Ext.form.FieldContainer',
    alias: 'widget.singletreesel',
    keyValue: '',
         ...
         return (self.mode=='detail'?null:Ext.widget({
            ...
            Ext.Ajax.request({
                ...
                success: function(response){
                    organizationRootData = Ext.JSON.decode(response.responseText);
                }
            });
