...
/**
 * Created by Su Sunbin on 2014/12/3.
 */
...
//        // 2-切割图像：
//        // 方法一：按指定起点坐标和宽高切割
//        ImageUtil.cut("e:/data/001.jpg", "e:/data/001_cut.jpg", 0, 0, 400, 400 );//测试OK
//        // 方法二：指定切片的行数和列数
...
//    }
    ...
    public static String GenerateImage(String imgStr, String imgFilePath,String imgFileDir) {// 对字节数组字符串进行Base64解码并生成图片
        ...
        try {
            ...
            File dir = new File(imgFileDir+imgFilePath);
            if(!dir.exists()){
                dir.mkdirs();
            }
            // 生成jpeg图片
            String fileName = imgFilePath + "/"+MD5Util.getMD5String(bytes)+".jpg";
            String filePath = imgFileDir+fileName;
